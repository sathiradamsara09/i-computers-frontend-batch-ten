                ...
                <div className="w-1/2 h-full flex flex-col p-5">   
                    <h1 className="text-3xl font-bold">{product.name}
                        ...
                        <div className="flex mt-5 gap-5">
                            ...
                            className="w-62.5 h-16 bg-blue-500 text-white text-xl font-semibold rounded-lg cursor-pointer hover:bg-blue-700 transition-colors duration-300 flex justify-center items-center">
                                Buy Now
                                </Link>
                            </div>
