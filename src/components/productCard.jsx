...
export default function ProductCard(props){
    ...
    return(
       <Link to={"/overview/"+product.productId} state={product} className="w-[300px] h-[400px] mt-10 bg-white rounded-lg shadow-2xl overflow-hidden flex flex-col hover:[&_.primary-image]:opacity-0 border justify-between cursor-pointer">
